    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dogs_allowed', models.JSONField(blank=True, default=list, null=True, verbose_name='Dogs')),
                ('horses_allowed', models.JSONField(blank=True, default=list, null=True, verbose_name='Horses')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('access_condition', models.CharField(blank=True, choices=[('I', 'Impassable'), ('P+', 'Many potholes'), ('P', 'Potholes'), ('P-', 'Occasional potholes'), ('G', 'Good')], help_text='Condition of road to trailhead', max_length=2, null=True, verbose_name='Road access condition')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('access', models.CharField(blank=True, choices=[('FS', 'Forest Service Road'), ('P', 'Paved Road')], help_text='How is the trailhead accessed?', max_length=2, null=True)),
                ('access_distance', models.DecimalField(blank=True, decimal_places=1, help_text='If accessed via service road, length of service road from paved road to trailhead', max_digits=3, null=True, validators=[django.core.validators.MinValueValidator(0.1)])),
                ('access_condition', models.CharField(blank=True, choices=[('I', 'Impassable'), ('P+', 'Many potholes'), ('P', 'Potholes'), ('P-', 'Occasional potholes'), ('G', 'Good')], help_text='What is the condition of the road access to trailhead?', max_length=2, null=True)),
                ...
                ('pkg_estimate_begin', models.IntegerField(help_text='Approximate parking capacity full at trailhead arrival', validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)], verbose_name='Percentage Capacity Start')),
                ('pkg_estimate_end', models.IntegerField(help_text='Approximate parking capacity full at trailhead departure', validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)], verbose_name='Percentage Capacity End')),
